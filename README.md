...
| **TG-S-002** | **AI-Интеграция** | EGO TGBot полностью игнорирует входящие комментарии, не инициируя AI-обработку. | 1. Оставить комментарий под постом "Когда будет следующий пост?" (12:03). | Ответ AI должен быть сгенерирован и отправлен в Billing UI (`pending_responses`). | Комментарий остается без реакции. |
